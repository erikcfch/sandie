...
export const ELEMENTS: readonly ElementDef[] = [
  ...
  { id: 14, name: 'Hydrogen', category: 'gas', color: [230, 245, 255], defaultTemp: AMBIENT_TEMP, thermalConductivity: 0.05, family: 'chem', formula: 'H₂', form: 'gas', phase: 'gas', origin: 'inorganic', metallic: 'nonmetal', flammable: true, ignitionTemp: 100, burnProduct: 9, burnRate: 0.9, realDensity: 0.00009, specificHeat: 14.3 },
  ...
  { id: 42, name: 'Gunpowder', category: 'powder', color: [55, 52, 58], defaultTemp: AMBIENT_TEMP, thermalConductivity: 0.2, family: 'physical', form: 'powder', phase: 'solid', origin: 'organic', metallic: 'nonmetal', flammable: true, explosive: true, ignitionTemp: 180, burnProduct: 9, burnRate: 0.6, detonationTemp: 120, blastStrength: 110, realDensity: 1.7, specificHeat: 1.0 },
  { id: 43, name: 'Sodium', category: 'powder', color: [190, 188, 175], defaultTemp: AMBIENT_TEMP, thermalConductivity: 0.6, family: 'chem', formula: 'Na', form: 'powder', phase: 'solid', origin: 'inorganic', metallic: 'metal', realDensity: 0.97, specificHeat: 1.23 },
  { id: 44, name: 'Glass', category: 'static', color: [200, 225, 230], defaultTemp: AMBIENT_TEMP, thermalConductivity: 0.3, family: 'physical', form: 'static', phase: 'solid', origin: 'inorganic', metallic: 'nonmetal', realDensity: 2.5, specificHeat: 0.84 },
  { id: 45, name: 'Salt Water', category: 'liquid', color: [90, 150, 185], defaultTemp: AMBIENT_TEMP, thermalConductivity: 0.25, family: 'chem', form: 'liquid', phase: 'liquid', origin: 'inorganic', metallic: 'nonmetal', conductive: true, realDensity: 1.025, specificHeat: 3.9, viscosityRefLog10: 0 },
];
