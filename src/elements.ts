...
export const ELEMENTS: readonly ElementDef[] = [
  ...
  { id: 3, name: 'Water', category: 'liquid', density: 40, color: [64, 128, 220], defaultTemp: AMBIENT_TEMP, thermalConductivity: 0.25, heatCapacity: 4.0, family: 'physical', form: 'liquid', phase: 'liquid', origin: 'inorganic', metallic: 'nonmetal', realDensity: 1.0, specificHeat: 4.18, meltingPoint: 0, boilingPoint: 100 },
  ...
  { id: 7, name: 'Lava', category: 'liquid', density: 50, color: [220, 80, 20], defaultTemp: 800, thermalConductivity: 0.4, heatCapacity: 1.0, family: 'physical', form: 'liquid', phase: 'liquid', origin: 'inorganic', metallic: 'nonmetal', realDensity: 2.9, specificHeat: 1.0 },
